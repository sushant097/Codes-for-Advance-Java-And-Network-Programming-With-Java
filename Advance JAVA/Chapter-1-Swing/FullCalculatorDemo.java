...
public class FullCalculatorDemo extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		try {
			...
			info.setForeground(Color.red);
			info.setText("Input Some Number First!");
		}
